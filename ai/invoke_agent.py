...
#For this to run on a local machine in VScode, you need to set the AWS_PROFILE environment variable to the name of the profile/creden>

#check for credentials
#echo $AWS_ACCESS_KEY_ID
#echo $AWS_SECRET_ACCESS_KEY
#echo $AWS_SESSION_TOKEN
agentId = "RYN3WMIWMZ" #INPUT YOUR AGENT ID HERE
agentAliasId = "WIIC2JS395" #INPUT YOUR ALIAS ID HERE
theRegion = "us-west-2"
